...
cp $MARKET_ENGINE_SHELL_DIST_LICENCES_PATH/LICENCE_MARKET_ENGINE_CLIENT.txt $APPIMG_CLIENT_DIR
cp $MARKET_ENGINE_SHELL_DIST_LICENCES_PATH/LICENCE_GPL3.txt $APPIMG_CLIENT_DIR
cp $MARKET_ENGINE_SHELL_DIST_LICENCES_PATH/LICENCE_OFL_1.1.txt $APPIMG_CLIENT_DIR
