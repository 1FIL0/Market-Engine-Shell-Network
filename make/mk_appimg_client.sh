...
APP_LICENCES_DIR=$APPIMG_CLIENT_DIR/licences
...
cp $MARKET_ENGINE_SHELL_DIST_LICENCES_PATH/LICENCE_MARKET_ENGINE_CLIENT.txt $APP_LICENCES_DIR
cp $MARKET_ENGINE_SHELL_DIST_LICENCES_PATH/LICENCE_GPL3_ONEFIL.txt $APP_LICENCES_DIR
cp $MARKET_ENGINE_SHELL_DIST_LICENCES_PATH/LICENCE_OFL_1.1_ONEFIL.txt $APP_LICENCES_DIR
