...
APP_LICENCES_DIR=$APPIMG_API_DIR/licences

rm $APPIMG_API_PATH 2> /dev/null
rm -r $APP_BIN_DIR/* 2> /dev/null
rm -r $APP_LICENCES_DIR/* 2> /dev/null
mkdir -p $APP_BIN_DIR
mkdir -p $APP_LICENCES_DIR
...
cp $MARKET_ENGINE_SHELL_DIST_LICENCES_PATH/LICENCE_MARKET_ENGINE_API.txt $APP_LICENCES_DIR
cp $MARKET_ENGINE_SHELL_DIST_LICENCES_PATH/LICENCE_GPL3_ONEFIL.txt $APP_LICENCES_DIR
